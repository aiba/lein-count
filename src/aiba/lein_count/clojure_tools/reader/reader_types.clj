...
(ns ^{:doc "Protocols and default Reader types implementation"
      :author "Bronsa"}
    aiba.lein-count.clojure-tools.reader.reader-types
  (:refer-clojure :exclude [char read-line])
  (:require [aiba.lein-count.clojure-tools.reader.impl.utils :refer
...
(extend-protocol ReaderCoercer
  ...
  aiba.lein_count.clojure_tools.reader.reader_types.Reader
  (to-rdr [rdr] rdr)
  String
...
(extend-protocol PushbackReaderCoercer
  ...
  aiba.lein_count.clojure_tools.reader.reader_types.PushbackReader
  (to-pbr [rdr buf-len] (push-back-reader rdr buf-len))
  String
...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? aiba.lein_count.clojure_tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? aiba.lein_count.clojure_tools.reader.reader_types.PushbackReader rdr))
           (not (instance? aiba.lein_count.clojure_tools.reader.reader_types.StringReader rdr))
           (not (instance? aiba.lein_count.clojure_tools.reader.reader_types.InputStreamReader rdr))
