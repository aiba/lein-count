...
(ns ^{:doc "An EDN reader in clojure"
      :author "Bronsa"}
  aiba.lein-count.clojure-tools.reader.edn
  ...
  (:require [aiba.lein-count.clojure-tools.reader.reader-types :refer
            ...
            [aiba.lein-count.clojure-tools.reader.impl.utils :refer
            ...
            [aiba.lein-count.clojure-tools.reader :refer [default-data-readers]])
...
(defn read
  "Reads the first object from an IPushbackReader or a java.io.PushbackReader.
   ...
   aiba.lein-count.tools-reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per aiba.lein-count.tools-reader.edn/read"
